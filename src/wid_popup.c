                ...
                int32_t args, ...)
{
     ...
     */
    if (title) {
        ttf_text_size(&title_font, title, &titlew, &titleh, 0, 0, 1.0f, 1.0f,
                      false /* fixed width */);
    }
    ...
    { TREE_WALK(d, n) {
        ...
        ttf_text_size(&body_font, n->line, &w, &h, 0, 0, 1.0f, 1.0f,
                      false /* fixed width */);
        ...
        if (!strlen(n->line)) {
            if (!maxh) {
                ttf_text_size(&body_font, "Test", &w, &h, 0, 0, 1.0f, 1.0f,
                              false /* fixed width */);
...

    {
        ...
        while (n--) {
            ...
            ttf_text_size(&button_font, button_name, &w, &h, 0, 0, 1.0f, 1.0f,
                          false /* fixed width */);
    ...
    if (1)
    {
        ...
        while (n--) {
            ...
            const char *button_name = button_names[n];
            ttf_text_size(&body_font, button_name, &w, &h, 0, 0, 1.0f, 1.0f,
                          false /* fixed width */);
