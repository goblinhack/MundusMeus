...
WID_PROTO(wid_set_on_mouse_down)
WID_PROTO(wid_set_on_mouse_motion)
WID_PROTO(wid_set_on_mouse_focus_begin)
WID_PROTO(wid_set_on_mouse_focus_end)
WID_PROTO(wid_set_on_mouse_over_begin)
WID_PROTO(wid_set_on_mouse_over_end)
WID_PROTO(wid_set_on_mouse_up)
WID_PROTO(wid_set_on_destroy)
WID_PROTO(wid_set_on_destroy_begin)
WID_PROTO(wid_set_on_tick)
WID_PROTO(wid_set_on_display)
WID_PROTO(wid_set_on_display_top_level)
