...
###        random.seed(self.land_seed)
###
###        self.land_seed += 1
###        self.land_seed *= self.land_seed
###
###        self.level.land = biome_land_do.Maze(width=self.width,
###                                             height=self.height,
###                                             rooms=fixed_rooms,
###                                             rooms_on_level=15,
###                                             fixed_room_chance=10)
###
###        if not self.level.biome_land_do.generate_failed:
###            break
###
###    self.level.biome_land_do.dump_depth()
###    self.level.biome_land_do.dump(charmap.depth.floor)
###    self.level.biome_land_do.dump()
###
###
