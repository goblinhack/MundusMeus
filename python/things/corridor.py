...
def init():
    ...
    corridor_init(name="corridor4",
                  ...
                  long_name="dirty corridor",
                  tiles=[
                         "corridor4.1", "corridor4.2", "corridor4.3", "corridor4.4",
                         "corridor4.5", "corridor4.6", "corridor4.7", "corridor4.8",
                        ])
    ...
    corridor_init(name="corridor5",
                  ...
                  long_name="dirty corridor",
                  tiles=[
                         "corridor5.1", "corridor5.2", "corridor5.3", "corridor5.4",
                         "corridor5.5", "corridor5.6", "corridor5.7", "corridor5.8",
                        ])
    ...
    corridor_init(name="corridor6",
                  ...
                  long_name="dirty corridor",
                  tiles=[
                         "corridor6.1", "corridor6.2", "corridor6.3", "corridor6.4",
                         "corridor6.5", "corridor6.6", "corridor6.7", "corridor6.8",
                        ])
    ...
    corridor_init(name="corridor7",
                  ...
                  long_name="dirty corridor",
                  tiles=[
                         "corridor7.1", "corridor7.2", "corridor7.3", "corridor7.4",
                         "corridor7.5", "corridor7.6", "corridor7.7", "corridor7.8",
                        ])
    ...
    corridor_init(name="corridor8",
                  ...
                  long_name="dirty corridor",
                  tiles=[
                         "corridor8.1", "corridor8.2", "corridor8.3", "corridor8.4",
                         "corridor8.5", "corridor8.6", "corridor8.7", "corridor8.8",
                        ])
